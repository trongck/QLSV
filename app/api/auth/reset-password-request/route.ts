  ...
  try {
    ...
    return NextResponse.json({
      ...
      message: result.emailSent
        ...
        : "Cấp lại mật khẩu mới thành công và đã cập nhật vào hệ thống! Tuy nhiên, hệ thống không thể gửi email tự động (vui lòng liên hệ Admin để kiểm tra cấu hình EmailJS). Mật khẩu mới mặc định là ngày sinh dạng dd/mm/yy của bạn.",
      email: result.email,
      status: "Đã reset mật khẩu thành công."
    });
  } catch (error: unknown) {
