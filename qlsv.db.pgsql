...
CREATE TABLE public.cuoctrochuyen (
  ...
  loai character varying NOT NULL DEFAULT 'CaNhan'::character varying CHECK (loai::text = ANY (ARRAY['CaNhan'::character varying, 'Nhom'::character varying]::text[])),
  ngaytao timestamp without time zone NOT NULL DEFAULT now(),
  nguoidaxoa ARRAY DEFAULT '{}'::text[],
...
CREATE TABLE public.nhatky (
  ...
  CONSTRAINT nhatky_phancong_fkey FOREIGN KEY (maphancong) REFERENCES public.phancong(maphancong)
);
...
CREATE TABLE public.thanhvientrochuyen (
  ...
  CONSTRAINT thanhvientrochuyen_pkey PRIMARY KEY (macuoctrochuyen, mataikhoan),
  CONSTRAINT thanhvientrochuyen_tai_fkey FOREIGN KEY (mataikhoan) REFERENCES public.taikhoan(mataikhoan),
  CONSTRAINT thanhvientrochuyen_cuoc_fkey FOREIGN KEY (macuoctrochuyen) REFERENCES public.cuoctrochuyen(macuoctrochuyen)
);
...
CREATE TABLE public.tinnhan (
  ...
  macuoctrochuyen integer NOT NULL,
  mataikhoangui character varying NOT NULL,
  noidung text NOT NULL,
  filedinh character varying,
  ...
  CONSTRAINT tinnhan_cuoc_fkey FOREIGN KEY (macuoctrochuyen) REFERENCES public.cuoctrochuyen(macuoctrochuyen),
  CONSTRAINT tinnhan_gui_fkey FOREIGN KEY (mataikhoangui) REFERENCES public.taikhoan(mataikhoan)
);