...
import { useStudentExamResult } from "@/hooks/sinhvien/useStudentExamResult";
...
export function ExamResultView({ examId }: ExamResultViewProps) {
  ...
  const { loading, resultData } = useStudentExamResult(examId);
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-sm text-gray-500 leading-relaxed">
              ...
              <span className="font-bold text-gray-800">
                {new Date(ketqua.thoigiannopbai).toLocaleString("vi-VN")}
              </span>.
            </p>
          </div>
        </div>
                  ...
                  <div className="space-y-2">
                    {isEssay ? (
                      ...
                      cauhoi.dapan.map((opt: any) => {
                        ...
                        return (
                          <div key={opt.madapan} className={`p-3 rounded-xl border-2 flex items-center justify-between ${bgColor} ${borderColor}`}>
