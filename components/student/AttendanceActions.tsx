...
import { QrCode, ScanFace, X, CheckCircle, AlertCircle, RefreshCw, ChevronDown, Calendar, Upload, FileText } from "lucide-react";
...
export default function AttendanceActions({ onFilterChange, onCheckedIn }: AttendanceActionsProps) {
  ...
  const [modal, setModal] = useState<"qr" | "face" | "leave" | null>(null);
