...
CREATE TABLE public.baitap (
  ...
  CONSTRAINT baitap_magv_fkey FOREIGN KEY (magv) REFERENCES public.giangvien(magv)
);
...
CREATE TABLE public.chitietgiangvien (
  magv character varying NOT NULL,
  ...
  CONSTRAINT chitietgiangvien_pkey PRIMARY KEY (magv),
  CONSTRAINT chitietgiangvien_magv_fkey FOREIGN KEY (magv) REFERENCES public.giangvien(magv)
);
CREATE TABLE public.chitietsinhvien (
  masv character varying NOT NULL,
  quequan character varying,
  diachi character varying,
  sodienthoai character varying,
  emailcanhan character varying,
  ...
  CONSTRAINT chitietsinhvien_pkey PRIMARY KEY (masv),
  CONSTRAINT chitietsinhvien_masv_fkey FOREIGN KEY (masv) REFERENCES public.sinhvien(masv)
);
CREATE TABLE public.cuoctrochuyen (
  macuoctrochuyen integer NOT NULL DEFAULT nextval('cuoctrochuyen_macuoctrochuyen_seq'::regclass),
  maphancong integer,
  tieude character varying,
  loai character varying NOT NULL DEFAULT 'Rieng'::character varying CHECK (loai::text = ANY (ARRAY['Rieng'::character varying, 'NhomMon'::character varying]::text[])),
  ngaytao timestamp without time zone NOT NULL DEFAULT now(),
  CONSTRAINT cuoctrochuyen_pkey PRIMARY KEY (macuoctrochuyen),
  CONSTRAINT cuoctrochuyen_maphancong_fkey FOREIGN KEY (maphancong) REFERENCES public.phancong(maphancong)
);
...
CREATE TABLE public.dethi (
  ...
  maphancong integer NOT NULL,
  magvtao character varying NOT NULL,
  tieude character varying NOT NULL,
  mota text,
  ...
  CONSTRAINT dethi_magvtao_fkey FOREIGN KEY (magvtao) REFERENCES public.giangvien(magv)
);
CREATE TABLE public.diem (
  ...
  CONSTRAINT diem_masv_fkey FOREIGN KEY (masv) REFERENCES public.sinhvien(masv),
  CONSTRAINT diem_maphancong_fkey FOREIGN KEY (maphancong) REFERENCES public.phancong(maphancong),
  CONSTRAINT diem_magvnhap_fkey FOREIGN KEY (magvnhap) REFERENCES public.giangvien(magv),
  CONSTRAINT diem_masv_maphancong_fkey FOREIGN KEY (masv) REFERENCES public.sinhvienmonhoc(masv),
  CONSTRAINT diem_masv_maphancong_fkey FOREIGN KEY (maphancong) REFERENCES public.sinhvienmonhoc(masv),
  CONSTRAINT diem_masv_maphancong_fkey FOREIGN KEY (masv) REFERENCES public.sinhvienmonhoc(maphancong),
  CONSTRAINT diem_masv_maphancong_fkey FOREIGN KEY (maphancong) REFERENCES public.sinhvienmonhoc(maphancong)
);
...
CREATE TABLE public.diemtongket (
  ...
  CONSTRAINT diemtongket_masv_fkey FOREIGN KEY (masv) REFERENCES public.sinhvien(masv),
  CONSTRAINT diemtongket_maphancong_fkey FOREIGN KEY (maphancong) REFERENCES public.phancong(maphancong),
  CONSTRAINT diemtongket_masv_maphancong_fkey FOREIGN KEY (masv) REFERENCES public.sinhvienmonhoc(masv),
  CONSTRAINT diemtongket_masv_maphancong_fkey FOREIGN KEY (maphancong) REFERENCES public.sinhvienmonhoc(masv),
  CONSTRAINT diemtongket_masv_maphancong_fkey FOREIGN KEY (masv) REFERENCES public.sinhvienmonhoc(maphancong),
  CONSTRAINT diemtongket_masv_maphancong_fkey FOREIGN KEY (maphancong) REFERENCES public.sinhvienmonhoc(maphancong)
);
...
CREATE TABLE public.lop (
  ...
  siso integer NOT NULL DEFAULT 0 CHECK (siso >= 0),
...
CREATE TABLE public.nhatky (
  manhatky integer NOT NULL DEFAULT nextval('nhatky_manhatky_seq'::regclass),
  masv character varying,
  magv character varying,
  tieude character varying,
  noidung text NOT NULL,
  tamtrang integer CHECK (tamtrang >= 1 AND tamtrang <= 5),
  riengtu boolean NOT NULL DEFAULT true,
  maphancong integer,
  ngaytao timestamp without time zone NOT NULL DEFAULT now(),
  ngaycapnhat timestamp without time zone NOT NULL DEFAULT now(),
  CONSTRAINT nhatky_pkey PRIMARY KEY (manhatky),
  CONSTRAINT nhatky_masv_fkey FOREIGN KEY (masv) REFERENCES public.sinhvien(masv),
  CONSTRAINT nhatky_magv_fkey FOREIGN KEY (magv) REFERENCES public.giangvien(magv),
  CONSTRAINT nhatky_maphancong_fkey FOREIGN KEY (maphancong) REFERENCES public.phancong(maphancong)
);
CREATE TABLE public.nhatkyhethong (
  ...
  CONSTRAINT nhatkyhethong_mataikhoan_fkey FOREIGN KEY (mataikhoan) REFERENCES public.taikhoan(mataikhoan)
);
...
CREATE TABLE public.tailieu (
  ...
  CONSTRAINT tailieu_magv_fkey FOREIGN KEY (magv) REFERENCES public.giangvien(magv)
);
CREATE TABLE public.thanhvientrochuyen (
  macuoctrochuyen integer NOT NULL,
  masv character varying,
  magv character varying,
  vaitro character varying DEFAULT 'ThanhVien'::character varying,
  ngaythamgia timestamp without time zone NOT NULL DEFAULT now(),
  thoigianxemcuoi timestamp without time zone,
  CONSTRAINT thanhvientrochuyen_macuoctrochuyen_fkey FOREIGN KEY (macuoctrochuyen) REFERENCES public.cuoctrochuyen(macuoctrochuyen),
  CONSTRAINT thanhvientrochuyen_masv_fkey FOREIGN KEY (masv) REFERENCES public.sinhvien(masv),
  CONSTRAINT thanhvientrochuyen_magv_fkey FOREIGN KEY (magv) REFERENCES public.giangvien(magv)
);
CREATE TABLE public.thongbao (
  mathongbao integer NOT NULL DEFAULT nextval('thongbao_mathongbao_seq'::regclass),
  magvtao character varying,
  maadmintao character varying,
  tieude character varying NOT NULL,
  noidung text NOT NULL,
  ...
  CONSTRAINT thongbao_magvtao_fkey FOREIGN KEY (magvtao) REFERENCES public.giangvien(magv),
  CONSTRAINT thongbao_maadmintao_fkey FOREIGN KEY (maadmintao) REFERENCES public.admin(maadmin),
  CONSTRAINT thongbao_malop_fkey FOREIGN KEY (malop) REFERENCES public.lop(malop),
  CONSTRAINT thongbao_maphancong_fkey FOREIGN KEY (maphancong) REFERENCES public.phancong(maphancong)
);
CREATE TABLE public.thongbaodadocgv (
  mathongbao integer NOT NULL,
  magv character varying NOT NULL,
  dadoc boolean NOT NULL DEFAULT false,
  thoigiandoc timestamp without time zone,
  CONSTRAINT thongbaodadocgv_pkey PRIMARY KEY (mathongbao, magv),
  CONSTRAINT thongbaodadocgv_mathongbao_fkey FOREIGN KEY (mathongbao) REFERENCES public.thongbao(mathongbao),
  CONSTRAINT thongbaodadocgv_magv_fkey FOREIGN KEY (magv) REFERENCES public.giangvien(magv)
);
CREATE TABLE public.thongbaodadocsv (
  mathongbao integer NOT NULL,
  masv character varying NOT NULL,
  dadoc boolean NOT NULL DEFAULT false,
  thoigiandoc timestamp without time zone,
  CONSTRAINT thongbaodadocsv_pkey PRIMARY KEY (mathongbao, masv),
  CONSTRAINT thongbaodadocsv_mathongbao_fkey FOREIGN KEY (mathongbao) REFERENCES public.thongbao(mathongbao),
  CONSTRAINT thongbaodadocsv_masv_fkey FOREIGN KEY (masv) REFERENCES public.sinhvien(masv)
);
CREATE TABLE public.thongkephancong (
  maphancong integer NOT NULL,
  sisohientai integer DEFAULT 0 CHECK (sisohientai >= 0),
  diemtb numeric,
  tilelop numeric,
  tilechuyencan numeric CHECK (tilechuyencan >= 0::numeric AND tilechuyencan <= 100::numeric),
  sobaitapcho integer DEFAULT 0,
  sobaitapdanop integer DEFAULT 0,
  ngaycapnhat timestamp without time zone NOT NULL DEFAULT now(),
  CONSTRAINT thongkephancong_pkey PRIMARY KEY (maphancong),
  CONSTRAINT thongkephancong_maphancong_fkey FOREIGN KEY (maphancong) REFERENCES public.phancong(maphancong)
);
CREATE TABLE public.thongkesinhvien (
  masv character varying NOT NULL,
  mahocky integer NOT NULL,
  gpa numeric,
  sotinchi integer DEFAULT 0,
  sotinchidat integer DEFAULT 0,
  tilechuyencan numeric CHECK (tilechuyencan >= 0::numeric AND tilechuyencan <= 100::numeric),
  somondat integer DEFAULT 0,
  somonkhongdat integer DEFAULT 0,
  ngaycapnhat timestamp without time zone NOT NULL DEFAULT now(),
  CONSTRAINT thongkesinhvien_pkey PRIMARY KEY (masv, mahocky),
  CONSTRAINT thongkesinhvien_mahocky_fkey FOREIGN KEY (mahocky) REFERENCES public.hocky(mahocky),
  CONSTRAINT thongkesinhvien_masv_fkey FOREIGN KEY (masv) REFERENCES public.sinhvien(masv)
);
CREATE TABLE public.tinnhan (
  matinnhan integer NOT NULL DEFAULT nextval('tinnhan_matinnhan_seq'::regclass),
  macuoctrochuyen integer NOT NULL,
  masvgui character varying,
  magvgui character varying,
  noidung text NOT NULL,
  filedinh character varying,
  dachinh boolean NOT NULL DEFAULT false,
  ngaytao timestamp without time zone NOT NULL DEFAULT now(),
  ngaycapnhat timestamp without time zone NOT NULL DEFAULT now(),
  CONSTRAINT tinnhan_pkey PRIMARY KEY (matinnhan),
  CONSTRAINT tinnhan_macuoctrochuyen_fkey FOREIGN KEY (macuoctrochuyen) REFERENCES public.cuoctrochuyen(macuoctrochuyen),
  CONSTRAINT tinnhan_masvgui_fkey FOREIGN KEY (masvgui) REFERENCES public.sinhvien(masv),
  CONSTRAINT tinnhan_magvgui_fkey FOREIGN KEY (magvgui) REFERENCES public.giangvien(magv)
);